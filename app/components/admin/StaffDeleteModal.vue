    ...
    <template #content>
      <div class="p-6 space-y-5">
        ...
        <div class="flex items-start gap-4">
          ...
          <div>
            <h2 class="text-base font-bold text-gray-900 dark:text-white">Remove Staff Member</h2>
            <p class="text-sm text-gray-500 mt-1 leading-relaxed">
              Are you sure you want to remove
              <span class="font-semibold text-gray-700 dark:text-gray-300">{{ staff?.name }}</span>
        ...
        <div class="flex justify-end gap-2">
          ...
          <UButton color="error" icon="i-lucide-user-x" @click="emit('confirm')">Remove Staff</UButton>
        </div>
      </div>
    </template>
  </UModal>
